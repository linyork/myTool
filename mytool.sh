...
do
    ...
    echo "  \033[31m1.\033[0m    查詢目前使用中的 port 及 process id"
    echo "  \033[31m2.\033[0m    查詢特定 port 的服務"
    echo "  \033[31m3.\033[0m    查詢進程資訊"
    echo "  \033[31m4.\033[0m    查詢當前環境變量"
    echo "  \033[31m5.\033[0m    查詢 gorup"

    printf "\E[0;32m"
    echo "--------------------------------------------------"
    printf "\E[0m"

    echo "  \033[31mq.\033[0m    離開"
    echo "  \033[31mc.\033[0m    清除畫面"
